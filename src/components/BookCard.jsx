...
import { bookDelete } from "../redux/thunk/bookDelete";
                ...
                <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-gray-500 space-x-2">
                      <button onClick={() => dispatch(editBook(book))} className="lws-edit">
                        <svg
                          fill="none"
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
                      ...
                      <button onClick={() => dispatch(bookDelete(book.id))} className="lws-delete">
                        <svg
                          fill="none"
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
